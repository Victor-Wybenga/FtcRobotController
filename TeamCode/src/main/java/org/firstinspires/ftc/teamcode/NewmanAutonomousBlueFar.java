...
@Autonomous(name = "Autonomous: Blue, Far Position", group = "Newman")
public class NewmanAutonomousBlueFar extends NewmanAutonomous {
    @Override public void setup() {
        forward_path = new PathPart[] {
                PathPart.Drive(PathDirection.FORWARD, 6.0),
